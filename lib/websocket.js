...
let WebSocket = function (params) {
     ...
     this.connect = function () {
          if (client_code === null && feed_token === null) return "client_code or feed_token is missing";
        //  if (task === "mw" || task === "sfi" || task === "dp") {
               ...
               ws.onopen = function onOpen(evt) {
                    ...
                    if(ws.readyState !== WebSocket.CLOSED){
                         console.log(ws.readyState === WebSocket.CLOSED,"=========Event=======",evt);
     ...
     this.taskCall = function (script, task) {
          console.log("========Task call is called============");

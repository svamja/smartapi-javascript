...
var SmartApi = function (params) {
    ...
    requestInstance.interceptors.response.use(response => {
        ...
        if (response.status === 200) {
            if (response.data.success || response.data.status) {
                ...
                if (response.data.errorCode === "AG8001") {
        ...
        token_data
            .then(response => {
                if (response.status) {
                    ...
                    // self.setClientCode(params.clientcode);
     ...
     */
    self.refreshOrderStatus = function (client_code) {
        let params = {
            "clientcode": client_code
        }
        return post_request("order_status", params);
    };
     ...
     * @param {string} type
     */
    self.covertPosition = function (params) {
        return post_request("covert_position", params);
    };
